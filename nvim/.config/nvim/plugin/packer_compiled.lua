...
_G.packer_plugins = {
  ...
  ["cmp-dictionary"] = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/cmp-dictionary",
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["cmp-spell"] = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/cmp-spell",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-easy-align"] = {
    loaded = true,
    path = "/home/joao/.local/share/nvim/site/pack/packer/start/vim-easy-align",
